export default class calculator {
    ...
    users: {'name': string, 'email': string}[] = [
        {name: 'John Donne', email: 'forwhom@thebellstoll.co.uk'},
        {name: 'Librarian', email: 'ook@unseen.edu'}
    ];
    ...
    products: {name: string, price: number, stock: number}[] = [
        {name: 'Pangalactic', price: 10, stock: 50},
        {name: 'Gargleblaster', price: 20, stock: 30}
    ];
     ...
     */
    role: [number, string, boolean] = [20, 'cool', true];
